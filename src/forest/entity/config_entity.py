# a dataclass is a shortcut in python to create classes that are mainly used to store data
# it automatically creates these three important things
# 1. __init__ for assigning values to the attributes
# 2. __repr__ for easy printing of the object
# __eq__ for comparison of two objects of the class
import os
