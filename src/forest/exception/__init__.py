import os
import sys # we are using here for exception details

# extract the detailed error message when an exception occurs
# extract filename, line number, error message itself
# it is taking two parameters, error and error_detail, second argument is expecting the sys module so you can call sys.exc_info()    
